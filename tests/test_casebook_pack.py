"""Regression checks for the parity-algo-path-lab casebook."""
...
from casebook.harness import assert_expected, parity_algo_path_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(parity_algo_path_lab_summary(), assert_expected())
